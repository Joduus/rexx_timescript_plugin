class TimeManagement {
    ...
    appendHtml() {
        let insertContainer: Element | null = parent.document.getElementsByClassName('my_absences_stats_description_container times_overview_stats_description_container')[0];
